...
cursor.execute("SELECT * FROM fcnf WHERE status=0")
rs = cursor.fetchall()
rec = rs[0]
...
print('''
    ...
    <td width=65%>
    <center>
        <br><h2>Pending Transaction: Farmer Requested Wholesaler</h2><br>
        <form name="frm" method="post" action="reject_code.py">
