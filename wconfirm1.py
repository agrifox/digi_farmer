...
#cursor.execute("SELECT * FROM fcnf WHERE wname='{}' ".format(wname))
cursor.execute('''SELECT f.*, w.* FROM fcnf f INNER JOIN freg w ON f.fname=w.name WHERE f.wname="{}" '''.format(wname))
rs=cursor.fetchall()
rec=rs[0]
print('''
        <br><center><h2>FARMER PENDING REQUEST</h2>
                        <br>
                        <center>
        ...
        if rec[7]==0:
            ...
            print('''
                <tr>
                    ...
                    '''.format(i, rec[2], rec[1], rec[3], rec[4], rec[5], rec[6],rec[0],rec[2],rec[0],rec[0],rec[2],rec[0]))
        else:
...
print('''
        <br><center><br><br><h2>FARMER CONFIRMED REQUEST</h2>
                        <br>
        ...
        if rec[7]==1:
            ...
            print('''
                <tr>
                    ...
                    '''.format(i, rec[2], rec[1], rec[3], rec[4], rec[5], rec[6],rec[10],rec[0],rec[2],rec[0]))
        else:
            print('''<tr><td colspan=10>No Rejected Request Found</td></tr>''')
        print('''</tbody>
                            </table>
...
print('''
        <br><center><br><br><h2>FARMER REJECTED REQUEST</h2>
                        <br>
        ...
        if rec[7] == 1:
            ...
            print('''
                <tr>
                    ...
                    '''.format(i, rec[2], rec[1], rec[3], rec[4], rec[5], rec[6], rec[0], rec[2], rec[0]))
        else:
