...
cursor.execute("SELECT * FROM fcnf WHERE status=2")
rs = cursor.fetchall()
#rec = rs[0]
...
print('''
    ...
    <td width=65%>
    <center>
        <br><h2>Rejected Transaction: Farmer Requested Wholesaler</h2><br>
    ...
    for rec in rs:
        ...
        print('''
            <tr>
                ...
                '''.format(i, rec[1], rec[2], rec[3], rec[4], rec[5], rec[6], rec[7]))
else:
    print('No Rejected Request Found')
