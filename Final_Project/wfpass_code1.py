...
cursor.execute("SELECT * FROM wreg WHERE contact='{}' AND name='{}' ".format(contact, name))
...
if result:
    for rec in result:
        ...
        print ('''<br><br><a href="wlogin1.py"><input type="button" value="Login Again"></a>''')
else:
    print (''' <br><br>Not Registered
    <br><br><a href="wregister1.py">
            <input type= "button" value="Register"><a href="wlogin1.py"><input type="button" value="Login Again"></a>
        </a>''')
print('''</body>
        </html>''')
