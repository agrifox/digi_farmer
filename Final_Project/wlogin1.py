...
<br>
		<p>&nbsp;</p>
		<h2><b>Wholesaler Sign In/Register</b></h2>
		<br><br>
<div class="container">
<form name="frm" method="post" action="wlogin_code1.py" class="loginbox">
...
<td align="center"><a class="btn btn-success" href="wfpass1.py" role="button">Retrieve your Password</a></td></tr>
<tr>
<td>Haven't registered yet?</td>
<td colspan="2" align="center"><a class="btn btn-success" href="wregister1.py" role="button">Register</a></td></tr>
</table>
	</center>
		<center>
			<br><br>
