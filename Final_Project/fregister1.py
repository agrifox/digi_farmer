...
<body style="text-align: right; top: 120px; border-radius: 20px; background-color: #FFFFFF; width: 100%; height: 300px;">
	...
	<br><br><br><br><br><br>
<nav id="nav" style=" color: green; background-color: darkseagreen; width: 99%" align="=right"><a href="home1.py">HOME</a> | | <a href="flogin1.py">LOGIN</a></nav>
	<br>
<center>
	<h2><b>Farmer Sign Up</b></h2>
<div class="container">
 <form name="user_reg" method="post" action="fregister_code1.py">
	 <br>
	 <table cellspacing=5 cellpadding=5>
 <div class="form-group">
    <tr><td><label>Farmer Name*</label></td>
    <td><input type="text" class="form-control" placeholder="Farmer Name" name="name" required></td></tr>
	 </div>
  <div class="form-group">
